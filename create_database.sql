...
CREATE TABLE table_departments(
                                  ...
                                  person_id INTEGER REFERENCES table_persons(person_id),
                                  description TEXT,
                                  is_active BOOLEAN NOT NULL DEFAULT TRUE
);
...
CREATE TABLE table_clients(
                              ...
                              phone TEXT NOT NULL,
                              email TEXT,
                              worker_id INTEGER NOT NULL REFERENCES table_workers(worker_id),
                              is_active BOOLEAN NOT NULL DEFAULT TRUE
);
...
CREATE TABLE table_orders(
                             ...
                             name TEXT NOT NULL,
                             client TEXT NOT NULL REFERENCES table_clients(name),
...
CREATE TABLE table_processes(
                                ...
                                quantity INTEGER NOT NULL,
                                operation TEXT REFERENCES table_operations(name),
                                oper_duration INTERVAL NOT NULL,
                                type TEXT NOT NULL,
                                date_start DATE NOT NULL,
...
INSERT INTO table_departments (name, person_id, description)
...
INSERT INTO table_clients (name, address, phone, email, worker_id)
...
INSERT INTO table_orders (name, client, date_start, date_end_plan, date_end, total_cost, description)
VALUES ('Заказ 0001', 'Газпром', '2025-01-01', '2025-05-10', '2025-06-10',100000, 'Произвести детали трубопровода для газа'),
       ('Заказ 0002', 'Роснефть','2025-01-02', '2025-06-10', '2025-06-10',200000, 'Произвести детали трубопровода для нефти'),
       ('Заказ 0003', 'Лукойл','2025-01-03', '2025-07-10', '2025-06-10',150000, 'Произвести детали трубопровода для нефти'),
       ('Заказ 0004', 'Газпром','2025-01-04', '2025-08-10', '2025-06-10',120000, 'Произвести детали трубопровода для газа'),
       ('Заказ 0005', 'Роснефть','2025-01-05', '2025-09-10', '2025-06-10',250000, 'Произвести детали трубопровода для нефти');
...
VALUES ('Заказ 0008', 'Газпром', '2025-01-01', '2025-05-10', 100000, 'Произвести детали трубопровода для газа')